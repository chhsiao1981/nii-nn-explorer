import { cmapper, type Niivue, NVImage } from "@niivue/niivue";
import type { vec3 } from "gl-matrix";
import { NIFTI2 } from "nifti-reader-js";
import { useState } from "react";
import { genID } from "use-thunk";
...
export const niivueInfoToNVImage = (niivueInfo: NIIVueInfo): NVImage => {
  ...
  hdr.pixDims = [
    1,
    niivueInfo.spacingRAS[0],
    niivueInfo.spacingRAS[1],
    niivueInfo.spacingRAS[2],
  ];
  hdr.vox_offset = 352;
  hdr.scl_slope = 0;
  hdr.scl_inter = 0;
